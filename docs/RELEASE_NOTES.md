...
Highlights
- Editor polish: focus behavior, slash commands, stable toolbar actions, and capture handoff.
- Linking and discovery: wikilink autocomplete, backlinks with context, link previews, search highlights/history, and unlinked references.
- Rendering upgrades: markdown display parity, code copy + language badges, and diagram previews with error fallback.
